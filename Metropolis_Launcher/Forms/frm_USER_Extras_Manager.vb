Public Class frm_USER_Extras_Manager
	...
	Public Sub New(ByVal id_Emu_Games As Integer, ByVal al_Screenshots As ArrayList)
		...
		Select Case TC.NZ(row_Emu_Game("id_Moby_Platforms"), 0)
			...
			Case Else
				...
				FileName = Alphaleonis.Win32.Filesystem.Path.GetFileNameWithoutExtension(TC.NZ(MKNetLib.cls_MKStringSupport.GetCleanFileName(FileNameX), ""))
		End Select
