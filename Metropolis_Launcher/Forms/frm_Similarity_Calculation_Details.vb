...
#If DEBUG Then
		...
		'Devexpress.XtraEditors.XtraMessageBox.Show("Debug: Test with id_Moby_Releases")
#End If
		...
		lbl_001_Platform_A_Text.Text = TC.NZ(DataAccess.FireProcedureReturnScalar(cls_Globals.Conn, 0, "SELECT PLTFM.Name FROM tbl_Emu_Games EG LEFT JOIN tbl_Moby_Platforms PLTFM ON EG.id_Moby_Platforms = PLTFM.id_Moby_Platforms WHERE EG.id_Emu_Games = " & TC.getSQLFormat(id_Emu_Games_A)), "<none>")
		If bUseMobyReleaseOnly OrElse bTestUseMobyRelease Then
		...
		Else
			lbl_001_Platform_B_Text.Text = TC.NZ(DataAccess.FireProcedureReturnScalar(cls_Globals.Conn, 0, "SELECT PLTFM.Name FROM tbl_Emu_Games EG LEFT JOIN tbl_Moby_Platforms PLTFM ON EG.id_Moby_Platforms = PLTFM.id_Moby_Platforms WHERE EG.id_Emu_Games = " & TC.getSQLFormat(_id_Emu_Games_B)), "<none>")
		End If
		...
		If IsNumeric(row_BTA("Weight")) AndAlso IsNumeric(row_BTA("Score")) Then
			...
			iSumWeightedScore += row_BTA("Weighted_Score")
		End If
		lbl_002_MobyRank_A_Text.Text = TC.NZ(DataAccess.FireProcedureReturnScalar(cls_Globals.Conn, 0, "SELECT	REL.MobyRank FROM	tbl_Emu_Games EMUGAME LEFT JOIN tbl_Moby_Games GAME ON EMUGAME.Moby_Games_URLPart = GAME.URLPart LEFT JOIN tbl_Moby_Releases REL ON EMUGAME.id_Moby_Platforms = REL.id_Moby_Platforms AND GAME.id_Moby_Games = REL.id_Moby_Games WHERE EMUGAME.id_Emu_Games = " & TC.getSQLFormat(id_Emu_Games_A)), "<none>")
		If bUseMobyReleaseOnly OrElse bTestUseMobyRelease Then
		...
		Else
			lbl_002_MobyRank_B_Text.Text = TC.NZ(DataAccess.FireProcedureReturnScalar(cls_Globals.Conn, 0, "SELECT	REL.MobyRank FROM	tbl_Emu_Games EMUGAME LEFT JOIN tbl_Moby_Games GAME ON EMUGAME.Moby_Games_URLPart = GAME.URLPart LEFT JOIN tbl_Moby_Releases REL ON EMUGAME.id_Moby_Platforms = REL.id_Moby_Platforms AND GAME.id_Moby_Games = REL.id_Moby_Games WHERE EMUGAME.id_Emu_Games = " & TC.getSQLFormat(_id_Emu_Games_B)), "<none>")
		End If
		...
		If IsNumeric(row_BTA("Weight")) AndAlso IsNumeric(row_BTA("Score")) Then
			...
			iSumWeightedScore += row_BTA("Weighted_Score")
		End If
		lbl_004_Publisher_A_Text.Text = TC.NZ(DataAccess.FireProcedureReturnScalar(cls_Globals.Conn, 0, "SELECT	IFNULL(EMUGAME.Publisher, C1.Name) FROM	tbl_Emu_Games EMUGAME LEFT JOIN tbl_Moby_Games GAME ON EMUGAME.Moby_Games_URLPart = GAME.URLPart LEFT JOIN tbl_Moby_Releases REL ON EMUGAME.id_Moby_Platforms = REL.id_Moby_Platforms AND GAME.id_Moby_Games = REL.id_Moby_Games LEFT JOIN tbl_Moby_Companies C1 ON REL.Publisher_id_Moby_Companies = C1.id_Moby_Companies WHERE EMUGAME.id_Emu_Games = " & TC.getSQLFormat(id_Emu_Games_A)), "<none>")
		If bUseMobyReleaseOnly OrElse bTestUseMobyRelease Then
		...
		Else
			lbl_004_Publisher_B_Text.Text = TC.NZ(DataAccess.FireProcedureReturnScalar(cls_Globals.Conn, 0, "SELECT	IFNULL(EMUGAME.Publisher, C1.Name) FROM	tbl_Emu_Games EMUGAME LEFT JOIN tbl_Moby_Games GAME ON EMUGAME.Moby_Games_URLPart = GAME.URLPart LEFT JOIN tbl_Moby_Releases REL ON EMUGAME.id_Moby_Platforms = REL.id_Moby_Platforms AND GAME.id_Moby_Games = REL.id_Moby_Games LEFT JOIN tbl_Moby_Companies C1 ON REL.Publisher_id_Moby_Companies = C1.id_Moby_Companies WHERE EMUGAME.id_Emu_Games = " & TC.getSQLFormat(_id_Emu_Games_B)), "<none>")
		End If
